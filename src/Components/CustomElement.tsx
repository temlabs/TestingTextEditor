...
const CustomElement = React.forwardRef((props: CustomElementProps, ref) =>
    React.createElement(elements[props.type], {
        key: props.nodeObject.id,
        ref: ref,
        onKeyUp: (e: React.KeyboardEvent) => props.handleKeyUpFn(e, props.nodeObject),
        onKeyDown: (e: React.KeyboardEvent) => props.handleKeyDownFn(e, props.nodeObject),
